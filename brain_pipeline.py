...
if __name__ == '__main__':
    ...
    patients = glob('R:/ENTC_7th_Sem/Deep Learning/HA/Updated/Dataset/BRATS-2/Image_Data/HG/**')
    save_patient_slices(patients, 'reg')
    save_patient_slices(patients, 'norm')
    save_patient_slices(patients, 'n4')
    labels = glob('R:/ENTC_7th_Sem/Deep Learning/HA/Updated/Dataset/BRATS-2/Image_Data/HG/**/*more*/**.mha')
    save_labels(labels)
